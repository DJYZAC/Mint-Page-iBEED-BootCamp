...
export default function Home(){
  ...
  // Campos a Serem Personalizados
    const nameProjet = "BootCamp iBEED DJYZAC Aula 04"  // Nome do seu Projeto
    const { contract } = useContract("0xC5BEa01B258F5E710D2Aa83fe36C2c078918421d") // Endereço da sua Coleção
